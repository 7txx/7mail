    ...
    <div className="text-slate-200">
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold gradient-text">7Mail 临时邮箱</h2>
            <p className="text-xs text-slate-400">傲始网络 · 保护隐私，拒绝垃圾邮件</p>
          </div>
        </div>
        ...
        <div className="bg-slate-800/30 rounded-xl p-4 border border-slate-700/50">
          ...
          <p className="text-sm text-slate-300 leading-relaxed">
            7Mail 是一款免费的临时邮箱服务，不用注册、不用绑手机号，点一下就能生成一个邮箱地址，
        ...
        <div className="bg-slate-800/30 rounded-xl p-4 border border-slate-700/50">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">✓</span>
              <span><strong className="text-white">多域名支持</strong> — 多个后缀随便选，不怕被拉黑</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">✓</span>
        ...
        <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-xl p-4 border border-cyan-500/20">
          <h3 className="font-semibold text-white mb-2 flex items-center gap-2">
            <span className="text-cyan-400">👨‍🌾</span> 关于
          </h3>
          <p className="text-sm text-slate-300 leading-relaxed mb-3">
            我是 傲始网络，互联网科技、跨境工具、网络媒体知识。
            这个项目是我在原版 vmail 基础上二开的，目的是让更多人能轻松搭建自己的临时邮箱。
          </p>
          <a
            href="https://www.ao-s.cn"
            target="_blank"
        ...
        <div className="bg-slate-800/30 rounded-xl p-4 border border-slate-700/50">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            临时邮箱是为了保护隐私，不是用来干坏事的。请不要用它发送垃圾邮件、诈骗信息或任何违法内容。
