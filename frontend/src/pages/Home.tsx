        ...
        <div className="w-full lg:w-[440px] shrink-0 space-y-4">
          ...
          <div className="glass-card p-4 bg-gradient-to-br from-cyan-500/5 to-purple-500/5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-white">傲始网络</span>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              <a
                ...
                <span className="text-[10px] text-slate-400 group-hover:text-cyan-400 transition-colors">官网</span>
              </a>
              <a
                href="https://space.bilibili.com/502040157"
                target="_blank"
                rel="noopener noreferrer"
